    ...
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold">LIBRAIRIE CHAJAE</h1>
            </a>
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <form action="">
                        <div class="form-group">
                            <input type="text" class="form-control border-0 py-4" placeholder="votre nome" required="required" />
                        </div>
                        <div class="form-group">
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-center px-xl-0">
            ...
            <p class="mb-md-0 text-center text-md-left text-dark">
                &copy; <a class="text-dark font-weight-semi-bold" href="#">MADE BY ZAKARIA CHAJAE</a>
...
<!-- Template Javascript -->
<script src="{{asset('sassets/js/main.js')}}"></script>