    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 px-2">-</p>
                <p class="m-0">date d'ajout : plus ancien</p>
            </div>
        </div>
    </div>
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <form action="" method="get">
                                <select class="form-select" onchange="if (this.value) window.location.href=this.value" aria-label="Default select example">
                                    ...
                                    <option value="{{url('/orderBy/oldest')}}" selected>Date d'ajout (anicen)</option>
                    ...
                    @foreach($premierProduits as $produit)
